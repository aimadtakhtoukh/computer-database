...
<%@ attribute name="currentPageNumber" required="true" type="java.lang.Integer" description="Sets the number of pages." %>
<%@ attribute name="resultsPerPage" required="true" type="java.lang.Integer" description="Sets the number of results per page." %>
<%@ attribute name="paginationStart" required="true" type="java.lang.Integer" description="Sets at which page the pagination starts." %>
<%@ attribute name="paginationFinish" required="true" type="java.lang.Integer" description="Sets at which page the pagination finishes." %>
